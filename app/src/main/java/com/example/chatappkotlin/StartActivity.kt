...
import com.example.chatappkotlin.MainActivity
...
//                builderSingle.setIcon(R.drawable.ic_send_black_24dp);
    ...
    fun initializeMapData() {
        ...
        dict1!!["uid"] = "bEZk7g7QWFWbrhniayuvgazwA5E3"
        ...
        dict2!!["uid"] = "6ynivgu5OxevI1VDL5Dtv9ayUdl1"

        arrMap!!.add(1, dict2!!)

        dict3 = HashMap()
        dict3!!["name"] = "babarian"
        dict3!!["email"] = "barbarian@fbase.com"
        dict3!!["uid"] = "3FyMrCey2XQMFnxi44SLeJbz3YN2"
        ...
        dict4!!["uid"] = "8UXoD0O1QFbrluZuOQwtmoFfjfv1"
        ...
        dict5!!["uid"] = "BCkzp2eT3TYv55aA9Fk0ZbGYxd93"
